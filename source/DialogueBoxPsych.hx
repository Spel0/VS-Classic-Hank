	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			...
			case 'psychic':
				...
				char.y -= 140;
			case 'modBf':
				char.frames = Paths.getSparrowAtlas('dialogue/bf');
				char.animation.addByPrefix('talkIdle', 'default', 24, true);
				char.animation.addByPrefix('talk', 'default', 24, true);
				char.animation.addByPrefix('scared', 'shaking', 24, true);
				char.flipX = !char.flipX;
			case 'hank':
				char.frames = Paths.getSparrowAtlas('dialogue/hankPort');
				switch (PlayState.SONG.song.toLowerCase())
				{
				case 'crossface':
					char.animation.addByPrefix('talkIdle', 'hankPort hankPort1', 24, true);
					char.animation.addByPrefix('talk', 'hankPort hankPort1', 24, true);
				case 'iniquitous':
					char.animation.addByPrefix('talkIdle', 'hankPort hankPort2', 24, true);
					char.animation.addByPrefix('talk', 'hankPort hankPort2', 24, true);
				case 'bamf':
					char.animation.addByPrefix('talkdIdle', 'hankPort hankPort3', 24, true);
					char.animation.addByPrefix('talk', 'hankPort hankPort3', 24, true);
				}
				char.y += 40;
			case 'clown':
				char.frames = Paths.getSparrowAtlas('dialogue/trickyPort');
				char.animation.addByPrefix('talkIdle', 'trickyPort trickyNeutral', 24, true);
				char.animation.addByPrefix('talk', 'trickyPort trickyNeutral', 24, true);
				char.y += 110;
		}
