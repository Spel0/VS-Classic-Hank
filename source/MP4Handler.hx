...
class MP4Handler
{
	...
	public function playMP4(path:String, callback:Dynamic, ?repeat:Bool = false, ?isWindow:Bool = false, ?isFullscreen:Bool = false):Void
	{
		...
		vlcBitmap.volume = FlxG.sound.volume / 3;
