	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				// credTextShit.screenCenter();
				case 9:
					createCoolText(['Friday Night Combat by'], 45);
				// credTextShit.visible = true;
				case 11:
					addMoreText('JoeApril17th', 45);
					addMoreText('Spelo', 45);
					addMoreText('CFunct', 45);
					addMoreText('Wyatt', 45);
				// credTextShit.text += '\nlmao';
				case 12:
					deleteCoolText();
				// credTextShit.visible = false;
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Combat'); // credTextShit.text += '\nFunkin';
